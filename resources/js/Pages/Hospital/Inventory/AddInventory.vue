        ...
        <div class="p-4 sm:p-8">
            <Container>
                ...
                <form @submit.prevent="submit" class="space-y-6">
                    <SessionMessage :status="status" v-if="form.recentlySuccessful" class="w-full sm:w-1/2" />
                    ...
                    <div class="mb-4">
                        ...
                        <div class="relative mt-1 rounded-lg">
                            ...
                            <select
                                ...
                                class="block w-full sm:w-1/2 rounded-md pr-3 pl-9 text-sm dark:text-slate-900 border-slate-300 outline-0 focus:ring-1 focus:ring-inset focus:ring-blue-400 focus:border-blue-400 placeholder:text-slate-400"
                            >
                                <option></option>
                    ...
                    <!-- Source Select -->
                    <div class="mb-4">
                        <label for="source" class="block text-sm font-medium text-slate-700 dark:text-slate-300">
                            Source
                        </label>
                        <div class="relative mt-1 rounded-lg">
                            <div class="pointer-event-non absolute inset-y-0 left-0 flex items-center pl-3">
