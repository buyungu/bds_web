        ...
        <div class="p-4 sm:p-8">
            <Container>
                ...
                <form @submit.prevent="submit" class="space-y-6">
                    <SessionMessage :status="status" v-if="form.recentlySuccessful" class="w-full sm:w-1/2 mx-auto" />
                    ...
                    <div class="flex flex-col md:flex-row gap-8">
                        ...
                        <div class="space-y-6 w-full">
                            ...
                            <!-- Urgency Select -->
                            <div class="mb-4">
                                <label for="urgency" class="block text-sm font-medium text-slate-700 dark:text-slate-300">
                                    Urgency
                                </label>
                                <div class="relative mt-1 rounded-lg">
                                    <div class="pointer-event-non absolute inset-y-0 left-0 flex items-center pl-3">
                    ...
                    <PrimaryBtn :disabled="form.processing" class="w-full sm:w-auto">Request</PrimaryBtn>
                </form>
            </Container>
        </div>
    </div>
