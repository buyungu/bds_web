...
<template>
    <Container class="mb-8">
        <div class="mb-8">
            <Title class="text-center">Add New User</Title>
        </div>
        <form @submit.prevent="submit" class="space-y-6">
            <div class="grid place-items-center mb-4">
                ...
                <p class="error mt-2 text-red-500 text-sm">{{ form.errors.avatar }}</p>
            </div>
                    ...
                    <div>
                        ...
                        <div class="relative mt-1 rounded-md">
                            ...
                            <input
                                ...
                                :class="{
                                    'border-red-500 ring-1 ring-red-500': form.errors.password_confirmation // Corrected error check
                                }"
                                class="block w-full pl-9 rounded-md text-sm dark:text-slate-900 border-slate-300 outline-0 focus:ring-1 focus:ring-inset focus:ring-blue-400 focus:border-blue-400 placeholder:text-slate-400"
                            />
                        </div>
            ...
            <PrimaryBtn :disabled="form.processing" class="w-full sm:w-auto mt-6">Add User</PrimaryBtn>
        </form>
    </Container>
</template>