                    ...
                    <div class="mb-4">
                        ...
                        <div class="relative mt-1">
                            ...
                            <select
                                ...
                                class="block w-full sm:w-1/2 rounded-md pl-9 pr-3 text-sm dark:text-slate-900 border-slate-300 focus:ring-blue-400 focus:border-blue-400"
                            >
                    ...
                    <div>
                        ...
                        <div class="relative mt-1">
                            ...
                            <input
                                ...
                                class="block w-full sm:w-1/2 pl-9 rounded-md text-sm dark:text-slate-900 border-slate-300 focus:ring-blue-400 focus:border-blue-400"
                            />
                        </div>
